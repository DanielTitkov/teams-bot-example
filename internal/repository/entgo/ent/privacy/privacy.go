...
// The DialogQueryRuleFunc type is an adapter to allow the use of ordinary
// functions as a query rule.
type DialogQueryRuleFunc func(context.Context, *ent.DialogQuery) error

// EvalQuery return f(ctx, q).
func (f DialogQueryRuleFunc) EvalQuery(ctx context.Context, q ent.Query) error {
	if q, ok := q.(*ent.DialogQuery); ok {
		return f(ctx, q)
	}
	return Denyf("ent/privacy: unexpected query type %T, expect *ent.DialogQuery", q)
}

// The DialogMutationRuleFunc type is an adapter to allow the use of ordinary
// functions as a mutation rule.
type DialogMutationRuleFunc func(context.Context, *ent.DialogMutation) error

// EvalMutation calls f(ctx, m).
func (f DialogMutationRuleFunc) EvalMutation(ctx context.Context, m ent.Mutation) error {
	if m, ok := m.(*ent.DialogMutation); ok {
		return f(ctx, m)
	}
	return Denyf("ent/privacy: unexpected mutation type %T, expect *ent.DialogMutation", m)
}
